...
export const SKILLS_SEED_DATA: SkillSeed[] = [
  createSkill('Node.js', ['node', 'nodejs', 'node js'], 'Backend', 'JavaScript runtime for backend services'),
  createSkill('NestJS', ['nestjs framework'], 'Backend', 'Progressive Node.js framework for server-side applications'),
  ...
  createSkill('Redux', ['redux toolkit', 'rtk'], 'Frontend', 'State management library for JavaScript apps'),
  ...
  createSkill('React Native', ['reactnative', 'rn'], 'Mobile', 'Framework for building native mobile apps with React'),
  ...
  createSkill('Docker', ['containers', 'containerization'], 'DevOps', 'Container packaging and runtime platform'),
  createSkill('Terraform', ['iac'], 'DevOps', 'Infrastructure as code provisioning tool'),
  createSkill('CI/CD', ['cicd', 'continuous integration', 'continuous delivery'], 'DevOps', 'Build and deployment automation practices'),
  createSkill('Linux', ['linux administration'], 'DevOps', 'Linux operating system usage and administration'),
  createSkill('Python', ['python3'], 'Programming Language', 'General-purpose programming language'),
  createSkill('Apache Spark', ['spark'], 'Data', 'Distributed processing engine for big data workloads'),
  createSkill('Kafka', ['apache kafka'], 'Data', 'Distributed event streaming platform'),
  createSkill('SQL', ['structured query language'], 'Database', 'Relational querying and data manipulation'),
  ...
  createSkill('Spring Boot', ['springboot'], 'Backend', 'Java framework for production-ready services'),
  createSkill('PostgreSQL', ['postgres', 'psql', 'pg'], 'Database', 'Open-source relational database'),
  ...
  createSkill('Playwright', ['playwright testing'], 'Testing', 'Cross-browser automation and testing framework'),
  createSkill('GCP', ['google cloud', 'google cloud platform'], 'Cloud', 'Google Cloud Platform services'),
  createSkill('Azure', ['microsoft azure'], 'Cloud', 'Microsoft cloud platform'),
  createSkill('Solution Design', ['solution architecture'], 'Architecture', 'Designing scalable technical solutions'),
  createSkill('Microservices', ['micro services'], 'Architecture', 'Distributed service architecture pattern'),
  createSkill('Go', ['golang'], 'Programming Language', 'Compiled systems programming language from Google'),
  createSkill('Swift', ['swift language'], 'Programming Language', 'Programming language for Apple platforms'),
  ...
  createSkill('Kotlin', ['kotlin language'], 'Programming Language', 'Modern JVM language for Android and backend'),
  createSkill('Jetpack Compose', ['compose'], 'Mobile', 'Declarative Android UI toolkit'),
  createSkill('Coroutines', ['kotlin coroutines'], 'Programming Concept', 'Asynchronous programming model in Kotlin'),
  createSkill('MVVM', ['model view viewmodel'], 'Architecture', 'Presentation architecture pattern'),
  createSkill('Android SDK', ['android sdk tools'], 'Mobile', 'Android platform SDK and APIs'),
  createSkill('Prometheus', ['prometheus monitoring'], 'DevOps', 'Metrics collection and monitoring system'),
  createSkill('Grafana', ['grafana dashboards'], 'DevOps', 'Observability and dashboard platform'),
  createSkill('Solidity', ['solidity smart contracts'], 'Blockchain', 'Smart contract language for EVM chains'),
  ...
  createSkill('Web3', ['web3.js', 'web3js'], 'Blockchain', 'Decentralized application integration stack'),
  createSkill('HuggingFace', ['hugging face'], 'AI/ML', 'Open-source ML models and tooling platform'),
  createSkill('LangChain', ['lang chain'], 'AI/ML', 'Framework for LLM application orchestration'),
  createSkill('Transformers', ['huggingface transformers'], 'AI/ML', 'Transformer model tooling and library'),
  ...
  createSkill('JavaScript', ['js', 'ecmascript', 'es6'], 'Programming Language', 'Core programming language for web development'),
  ...
  createSkill('Penetration Testing', ['pentest', 'pen testing'], 'Security', 'Security assessment through attack simulation'),
  createSkill('Burp Suite', ['burp'], 'Security', 'Web security testing toolkit'),
  createSkill('SAST/DAST', ['sast', 'dast'], 'Security', 'Static and dynamic application security testing'),
  ...
  createSkill('Team Leadership', ['tech leadership'], 'Leadership', 'Leading engineering teams and delivery'),
  createSkill('Agile', ['scrum', 'kanban'], 'Process', 'Iterative product and delivery methodology'),
  createSkill('System Design', ['design systems', 'system architecture'], 'Architecture', 'Designing scalable application systems'),
  createSkill('OKRs', ['objectives and key results'], 'Leadership', 'Goal-setting framework for teams and organizations'),
];